...
function config = phantom_config_eTM_examp_001_01(config)

    % Kinetic variables to be reported from model...
    config.KIN_VARS      = {'ktrans','ve','vp'};
    ...
    % values...
    config.PARAM_IN_FILE = '.\config\param_values_eTM_examp_01.csv';
    ...
    config.MAP_SF        = [1000.0, 1000.0, 10000.0];
