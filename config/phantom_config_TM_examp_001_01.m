...
function config = phantom_config_TM_examp_001_01(config)

    % Kinetic variables to be reported from model...
    config.KIN_VARS      = {'ktrans','ve'};
    ...
    % values...
    config.PARAM_IN_FILE = '.\config\param_values_TM_examp_01.csv';
    ...
    % Scale factors for output maps [ktrans, ve]...
    config.MAP_SF        = [1000.0, 1000.0];
